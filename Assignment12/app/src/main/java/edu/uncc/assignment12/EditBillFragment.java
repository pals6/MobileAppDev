...
public class EditBillFragment extends Fragment {
    ...
    String selectedCategory,selectedBillName;
    Date selectedBillDate;
    Double selectedDiscount,selectedAmount;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            selectedBillName=mBill.getName();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(selectedBillName == null){
            binding.editTextName.setText("N/A");
        } else {
            binding.editTextName.setText(selectedBillName);
        }
        if(selectedAmount == null){
            binding.editTextBill.setText("N/A");
        } else {
